...
public class AuthenticationController {
    ...
    @PostMapping("/token")
    ApiResponsee<AuthenticationResponse> authenticate(@RequestBody AuthenticationRequest request) {
        var result = authenticationService.authenticate(request);
        return ApiResponsee.<AuthenticationResponse>builder()
                .result(result)
                .build();
    ...
    ApiResponsee<IntrospectResponse> authenticate(@RequestBody IntrospectRequest request) throws ParseException, JOSEException {
        var result = authenticationService.introspect(request);
        return ApiResponsee.<IntrospectResponse>builder()
                .result(result)
                .build();
