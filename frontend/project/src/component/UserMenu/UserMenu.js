...
<ul>
<li class="active">
    <a href="https://ivymoda.com/customer/info"><span class="icon-ic_avatar-1"></span>Thông tin tài khoản</a>
</li>
<li class="">
    <a href="https://ivymoda.com/customer/order_list"><span class="icon-ic_reload"></span>Quản lý đơn hàng</a>
</li>
<li class="">
    <a href="https://ivymoda.com/customer/address_list"><span class="icon-ic_placeholder"></span>Sổ địa chỉ</a>
</li>
</ul>
</div>
              </div>     
